...
HELP_STRINGS = """
Hey there! My name is *{DEKU}*.
I am The Symbol of peace in this world,I will help you manage your groups! Have a look at the following for an idea of some of \
...
SAITAMA_IMG = "https://telegra.ph/Deku-03-14"
            ...
            update.effective_message.reply_animation(
                ...
                reply_markup=InlineKeyboardMarkup(                   
                          ...
                          [
                              InlineKeyboardButton(
                              text="🍁Support Group🍁",
                              url=f"https://t.me/otaku_cafe8"),
                              InlineKeyboardButton(
                              text="✨Updates Channel✨",
                              url="https://t.me/otaku_cafe8")
                          ]])) 
    else:
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1270604313 and DONATION_LINK:
            update.effective_message.reply_text(
